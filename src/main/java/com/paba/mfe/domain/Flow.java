...
public class Flow implements Serializable {
    ...
    @JsonIgnoreProperties(value = { "flow", "isSourceFor", "isDestFor" }, allowSetters = true)
    @OneToOne
    @JoinColumn(unique = true)
    private FileDescriptor originFileDescriptor;
    ...
    public FileDescriptor getOriginFileDescriptor() {
        return this.originFileDescriptor;
    }

    public void setOriginFileDescriptor(FileDescriptor fileDescriptor) {
        this.originFileDescriptor = fileDescriptor;
    }

    public Flow originFileDescriptor(FileDescriptor fileDescriptor) {
        this.setOriginFileDescriptor(fileDescriptor);
        return this;
    }
    ...
    public void setDestFileDescriptor(FileDescriptor fileDescriptor) {
        this.destFileDescriptor = fileDescriptor;
    }

    public Flow destFileDescriptor(FileDescriptor fileDescriptor) {
        this.setDestFileDescriptor(fileDescriptor);
        return this;
    }
    ...
    public void setFileDescriptor(FileDescriptor fileDescriptor) {
        if (this.fileDescriptor != null) {
            this.fileDescriptor.setFlow(null);
        }
        if (fileDescriptor != null) {
            fileDescriptor.setFlow(this);
        }
        this.fileDescriptor = fileDescriptor;
    }

    public Flow fileDescriptor(FileDescriptor fileDescriptor) {
